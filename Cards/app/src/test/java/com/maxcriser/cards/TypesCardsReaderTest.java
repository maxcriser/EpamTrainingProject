...
public class TypesCardsReaderTest {
    ...
    public void testRegex() {
        String text = "#$YHEH#$Y#$weg23/324w@##/33John Smith312/32###Maxim Zaharenko###3g3maistro4g34/tg+#@(@#JGJosé#Priorbank@ BrasãoSkof01234 4444 1235 23463#(@kol3t[Bbqfs@@i3k3gMAXIM ZAHARENKO29i39jgVISAp@";
        ...
        String text2 = "@PO#KT(*J)GO@<_)(*U)IGO_H#)(NU@32Priorank523523523rvos1111 3333 2222 111l23t23GWO>T)#)(GUVOQWPgoiego432t244/44l21t3-j0gnui-oL)#)#MG)W_(I)9.t30g90i";
