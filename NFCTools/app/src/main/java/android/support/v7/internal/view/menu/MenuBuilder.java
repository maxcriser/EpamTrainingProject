...
public class MenuBuilder implements C0078a {
    ...
    private void setHeaderInternal(int i, CharSequence charSequence, int i2, Drawable drawable, View view) {
        ...
        if (view != null) {
            ...
            if (i2 > 0) {
                this.mHeaderIcon = C0000a.m0a(getContext(), i2);
    ...
    private void setShortcutsVisibleInner(boolean z) {
        boolean z2 = true;
        if (!(z && this.mResources.getConfiguration().keyboard != 1 && this.mResources.getBoolean(C0291b.abc_config_showMenuShortcutsWhenKeyboardPresent))) {
            z2 = false;
        }
    ...
    public boolean performItemAction(MenuItem menuItem, MenuPresenter menuPresenter, int i) {
        ...
        C0187d supportActionProvider = menuItemImpl.getSupportActionProvider();
