...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    private class C0411a implements Callback {
        final /* synthetic */ ActionMenuView f864a;

        private C0411a(ActionMenuView actionMenuView) {
            this.f864a = actionMenuView;
        }
    ...
    private class C0412b implements MenuBuilder.Callback {
        final /* synthetic */ ActionMenuView f865a;

        private C0412b(ActionMenuView actionMenuView) {
            this.f865a = actionMenuView;
        }

        public boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem) {
            return this.f865a.mOnMenuItemClickListener != null && this.f865a.mOnMenuItemClickListener.onMenuItemClick(menuItem);
        }

        public void onMenuModeChange(MenuBuilder menuBuilder) {
            if (this.f865a.mMenuBuilderCallback != null) {
                this.f865a.mMenuBuilderCallback.onMenuModeChange(menuBuilder);
            }
        }
    }
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mMenu.setCallback(new C0412b());
            this.mPresenter = new ActionMenuPresenter(context);
            this.mPresenter.setReserveOverflow(true);
            this.mPresenter.setCallback(this.mActionMenuPresenterCallback != null ? this.mActionMenuPresenterCallback : new C0411a());
