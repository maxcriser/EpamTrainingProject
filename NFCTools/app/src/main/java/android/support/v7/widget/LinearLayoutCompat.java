...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0300k.LinearLayoutCompat_Layout);
            this.weight = obtainStyledAttributes.getFloat(C0300k.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = obtainStyledAttributes.getInt(C0300k.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0300k.LinearLayoutCompat, i, SHOW_DIVIDER_NONE);
        int i2 = obtainStyledAttributes.getInt(C0300k.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        i2 = obtainStyledAttributes.getInt(C0300k.LinearLayoutCompat_android_gravity, -1);
        if (i2 >= 0) {
            setGravity(i2);
        }
        boolean z = obtainStyledAttributes.getBoolean(C0300k.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C0300k.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C0300k.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C0300k.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(obtainStyledAttributes.getDrawable(C0300k.LinearLayoutCompat_divider));
        this.mShowDividers = obtainStyledAttributes.getInt(C0300k.LinearLayoutCompat_showDividers, SHOW_DIVIDER_NONE);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C0300k.LinearLayoutCompat_dividerPadding, SHOW_DIVIDER_NONE);
        obtainStyledAttributes.recycle();
    }
    ...
    void layoutHorizontal(int i, int i2, int i3, int i4) {
        ...
        switch (C0191e.m873a(i7, C0234u.m1090e(this))) {
            case VERTICAL /*1*/:
    ...
    void layoutVertical(int i, int i2, int i3, int i4) {
        ...
        while (i7 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                switch (C0191e.m873a(i5, C0234u.m1090e(this)) & 7) {
                    case VERTICAL /*1*/:
    ...
    void measureHorizontal(int i, int i2) {
        ...
        while (i11 < virtualChildCount) {
            ...
            if (virtualChildAt == null) {
                ...
                int combineMeasuredStates = ViewUtils.combineMeasuredStates(i7, C0234u.m1094h(virtualChildAt));
                if (z) {
        ...
        int a = C0234u.m1072a(Math.max(this.mTotalLength, getSuggestedMinimumWidth()), i, (int) SHOW_DIVIDER_NONE);
            ...
            while (i10 < virtualChildCount) {
                ...
                if (virtualChildAt3 == null) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        i9 = ViewUtils.combineMeasuredStates(i15, C0234u.m1094h(virtualChildAt3) & -16777216);
                        f5 = f3;
                    } else {
                        i12 = i14;
                        i9 = i15;
        ...
        setMeasuredDimension((-16777216 & i7) | a, C0234u.m1072a(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i7 << 16));
        if (obj3 != null) {
    ...
    void measureVertical(int i, int i2) {
        ...
        while (i12 < virtualChildCount) {
            ...
            if (virtualChildAt2 == null) {
                ...
                if (mode2 == 1073741824 && layoutParams.height == 0 && layoutParams.weight > 0.0f) {
                    ...
                    int i14 = i3;
                    measureChildBeforeLayout(virtualChildAt2, i12, i, SHOW_DIVIDER_NONE, i2, f2 == 0.0f ? this.mTotalLength : SHOW_DIVIDER_NONE);
                ...
                if (i12 >= i10 || layoutParams.weight <= 0.0f) {
                    ...
                    i6 = Math.max(i6, i13);
                    int combineMeasuredStates = ViewUtils.combineMeasuredStates(i7, C0234u.m1094h(virtualChildAt2));
        ...
        int a = C0234u.m1072a(Math.max(this.mTotalLength, getSuggestedMinimumHeight()), i2, (int) SHOW_DIVIDER_NONE);
        i5 = (16777215 & a) - this.mTotalLength;
        int i17;
        if (obj4 != null || (i5 != 0 && f > 0.0f)) {
            if (this.mWeightSum > 0.0f) {
            ...
            while (i11 < virtualChildCount) {
                ...
                if (virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        f4 = f3;
                        i12 = i15;
                        i15 = ViewUtils.combineMeasuredStates(i16, C0234u.m1094h(virtualChildAt3) & -256);
                        f5 = f4;
                    } else {
                        f5 = f3;
                        i12 = i15;
        ...
        setMeasuredDimension(C0234u.m1072a(Math.max(i3 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, i7), a);
        if (obj3 != null) {
